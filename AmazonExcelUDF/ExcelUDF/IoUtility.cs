...
namespace AmazonExcelUDF.ExcelUDF
{
    ...
    {
        [ExcelFunction(Category = "文件文件夹相关", Description = "根据给定的路径字符，合成文件路径，可以末尾无需输入路径分隔符")]
   ...
   [ExcelArgument(Description = @"从左往右拼接的文件夹/文件名路径，最后的\可有可没有")] string path5)
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取上一级的文件夹全路径")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取文件大小，单位KB")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "判断传入的文件或文件 夹路径是否是真实存在")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取文件或文件夹创建时间")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取文件或文件夹属性")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取文件或文件夹最后修改时间")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "在一个全路径下获取文件名，格式为：文件名+后缀名,如：C:\test\test.txt返回的是test.txt字符串")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "在一个全路径下获取文件名的后缀名，如：C:\test\test.txt返回的是.txt)")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "在一个全路径下获取文件名不含文件后缀名，如：C:\test\test.txt返回的是test字符串)")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取指定目录下的子文件夹,srcFolder为传入的顶层目录，containsText可用作筛选包含containsText内容的文件夹，isSearchAllDirectory为是否查找顶层目录下的文件夹的所有子文件夹")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取指定目录下的文件清单,srcFolder为传入的顶层目录，containsText可用作筛选包含containsText内容的文件夹，isSearchAllDirectory为是否查找顶层目录下的文件夹的所有子文件夹")]
        ...
        [ExcelFunction(Category = "文件文件夹相关", Description = "获取指定目录下的不同层级的文件夹名称")]
