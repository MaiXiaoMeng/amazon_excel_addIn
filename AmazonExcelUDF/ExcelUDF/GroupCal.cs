...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组最小值，实现的效果类似MINIF函数，但效率性能更高")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组最大值，实现的效果类似MAXIF函数，但效率性能更高")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组平均值，实现的效果类似AVERAGEIF函数，但效率性能更高")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求和，实现的效果类似SUMIF函数，但效率性能更高")]
      ...
      [ExcelArgument(Description = "求和列区域")] object[,] sumRange
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组美式排名")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组中式排名")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求和累计")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求末元素")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求首元素")]
      ...
      [ExcelArgument(Description = "排序列区域3是否按降序排列，默认为升序FALSE，TRUE时为降序")] bool isorderRange3Desc
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求下一元素")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组求上一元素")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组计数去重，实现的效果类似COUNTIF函固定首行绝对引用，但效率性能更高")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组计数，实现的效果类似COUNTIF函数，但效率性能更高")]
        ...
        [ExcelFunction(Category = "分组计算", Description = "分组列合并，用于分组列有多列时，需要使用此函数来引用多列")]
