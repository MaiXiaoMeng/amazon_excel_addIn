...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "查找引用增强", Description = "类似INDEX+MATCH套路，查找值在交叉表结构的数据区域中对应的值")]
        ...
        [ExcelFunction(Category = "查找引用增强", Description = "类似Vlookup的用法，查找某列的值在相对引用区域的对应的返回值")]
