...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则匹配组，Pattern里传入（）来分组")]
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则匹配组，返回多个结果，Pattern里传入（）来分组")]
  ...
  [ExcelArgument(Description = "从右往左匹配，默认为false")] bool isRightToLeft = false)
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则匹配，不含Group组匹配")]
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则匹配，返回多个结果，不含Group组匹配")]
   ...
   [ExcelArgument(Description = "从右往左匹配，默认为false")] bool isRightToLeft = false)
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则替换")]
        ...
        /// <returns></returns>
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则分割")]
        ...
        [ExcelFunction(Category = "文本处理_正则相关", Description = "正则匹配判断")]
