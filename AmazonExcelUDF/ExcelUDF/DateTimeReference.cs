...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历年份及节气名称返回对应年份下的节气所在日期")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历日期，返回对应的节气区间")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历日期，返回农历")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入中国农历日期，返回公历")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历日期，返回生肖")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历日期，返回干支年份")]
        ...
        [ExcelFunction(Category = "日期相关", Description = "输入公历日期，返回年龄或工龄，不足一年部分舍去")]
