...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "个人所得税", Description = "计算年终奖个人所得税，旧版3500起征的")]
        ...
        [ExcelFunction(Category = "个人所得税", Description = "计算工资个人所得税，旧版3500起征的")]
        ...
        [ExcelFunction(Category = "个人所得税", Description = "计算工资个人所得税，新版5000起征的")]
        ...
        [ExcelFunction(Category = "个人所得税", Description = "根据个税金额反算税前收入，新版5000起征的")]
        ...
        [ExcelFunction(Category = "个人所得税", Description = "根据税后收入反算税前收入，旧版3500起征的")]
        ...
        [ExcelFunction(Category = "个人所得税", Description = "根据税后收入反算税前收入，新版5000起征的")]
