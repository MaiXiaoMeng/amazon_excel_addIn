...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "中文相关", Description = "繁体转简体")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "简体转繁体")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "数字转换为多个单元格存放的效果，财务用途")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "数字转换为大写中文金额")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "中文转全拼")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "中文转首字母拼单")]
        ...
        [ExcelFunction(Category = "中文相关", Description = "大写中文金额转换为数字")]
