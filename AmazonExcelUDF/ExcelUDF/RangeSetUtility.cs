...
namespace AmazonExcelUDF.ExcelUDF
{
    ...
    {
        [ExcelFunction(Category = "区域集合处理", Description = "区域值根据源区域和其他交集区域，求对区域的值求交集返回数据集")]
        ...
        [ExcelFunction(Category = "区域集合处理", Description = "区域值根据源区域和其他并集区域，求对区域的值求并集返回数据集")]
        ...
        [ExcelFunction(Category = "区域集合处理", Description = "区域值根据源区域和其他补集区域，求对区域的值求补集返回数据集")]
