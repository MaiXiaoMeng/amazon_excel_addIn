...
namespace AmazonExcelUDF.ExcelUDF
{
    ...
    {
        private static XElement element = XElement.Load(new StringReader(Properties.Resources.行政区划数据库));
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取地区信息")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取所属生肖")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取所属干支年份")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取所属星座")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取性别")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），获取当前年龄，过了生日才算一年")]
        ...
        [ExcelFunction(Category = "身份证相关", IsThreadSafe = true, Description = "输入身份证号码（15位或18位，其他数字返回错误），取出生日期")]
