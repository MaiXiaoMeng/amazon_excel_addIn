...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "逻辑判断_日期", Description = "是否为日期，EXCEL可识别的日期为从1900-01-00至9999-12-31，即数字为0至2958465之间")]
        ...
        [ExcelFunction(Category = "逻辑判断_文本", Description = "判断字符是否在指定的字符串集合内，如果存在返回true，否则返回false，示例：sourceStrings=AB,CD,E,lookupValue=CD,strSplit=',',CD在｛AB，CD，E｝的集合中，返回true")]
        ...
        [ExcelFunction(Category = "逻辑判断_区域", Description = "判断查找区域内查找是否有查找条件相同的，如果存在返回true，否则返回false，示例：lookupValue:ABC,sourceRange:A1：A3｛ABC，BCD，EDF｝,ABC在sourceRange中，结果返回true")]
        ...
        [ExcelFunction(Category = "逻辑判断_区域", Description = "判断查找区域内查找是否有至少2个满足查找条件的值，如果存在返回true，否则返回false，示例：lookupValue:ABC,sourceRange:A1：A3｛ABC，ABC，EDF｝,ABC在sourceRange中出现2次，结果返回true")]
        ...
        [ExcelFunction(Category = "逻辑判断_文本", Description = "判断字符串是否以某字符开头")]
