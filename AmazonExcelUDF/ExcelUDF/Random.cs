...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "随机函数", IsVolatile = true, Description = "根据传入的字符长度，随机返回传入个数的任意26个大写字母")]
        ...
        [ExcelFunction(Category = "随机函数", IsVolatile = true, Description = "根据传入的字符长度，随机返回传入个数的任意26个小写字母")]
        ...
        [ExcelFunction(Category = "随机函数", IsVolatile = true, Description = "根据传入的字符长度，随机返回传入个数的任意26个字母，不分大小写")]
        ...
        [ExcelFunction(Category = "随机函数", IsVolatile = true, Description = "根据传入的字符长度，随机返回传入个数任意的0-9数字")]
        ...
        [ExcelFunction(Category = "随机函数", Description = "根据传入的字符长度，随机返回传入个数的英文字母或数字，即【0-9，a-z,A-Z】")]
