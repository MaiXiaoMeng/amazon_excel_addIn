...
namespace AmazonExcelUDF.ExcelUDF
{
    ...
    {
        [ExcelFunction(Category = "序列函数", Description = "选定区域内容重复，如选定区域内容为1,2,3，重复3次结果为123123123")]
        ...
        [ExcelFunction(Category = "序列函数", IsMacroType = true, Description = "生成重复循环序列，从输入函数公式开始向下填充AAABBBCCC这样结构的数据序列")]
        ...
        [ExcelFunction(Category = "序列函数", IsMacroType = true, Description = "生成重复循环序列，从输入函数公式开始向下填充111222333这样结构的数据序列")]
        ...
        [ExcelFunction(Category = "序列函数", IsMacroType = true, Description = "生成间隔循环序列，从输入函数公式开始向下填充123123123这样结构的数据序列")]
        ...
        [ExcelFunction(Category = "序列函数", IsMacroType = true, Description = "生成间隔循环序列，从输入函数公式开始向下填充ABCABCABC这样结构的数据序列")]
