...
namespace AmazonExcelUDF.ExcelUDF
{
    public partial class ExcelUDF
    {
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "提取指定字符")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "提取中文")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "提取数字")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "提取英文")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "替换英文")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "替换中文")]
        ...
        [ExcelFunction(Category = "文本处理_提取替换", Description = "替换指定字符")]
        ...
        [ExcelFunction(Category = "文本处理", Description = "字符串去重")]
        ...
        [ExcelFunction(Category = "文本处理", Description = "字符串反转")]
        ...
        [ExcelFunction(Category = "文本处理", Description = "字符串排序")]
        ...
        [ExcelFunction(Category = "文本处理", Description = "根据传入的分割字符，对字符串进行分割操作，返回多值")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "根据传入的分割字符，对字符串进行分割操作，返回第N个值")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "根据传入的待清洗字符，对其时行前后的字符清除")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "根据传入的待清洗字符，对其时行前面的字符清除")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "左侧填充指定个数字符")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "右侧填充指定个数字符")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "字符串拼接函数，StringJoinRange：传入的需要写入目标单元格的数据区域，strSplit：用来分割的字符")]
        ...
        [ExcelFunction(Category = "文本处理", IsThreadSafe = true, Description = "字符串拼接函数，在查找的区域查找对应条件下的值，最终用分隔符拼接起来，类似系统函数SUMIF、COUNTIF")]
