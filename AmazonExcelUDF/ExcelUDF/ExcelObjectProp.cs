...
namespace AmazonExcelUDF.ExcelUDF
{
    ...
    {
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的超链接地址")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的行高")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的缩进量")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的列宽")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的公式")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的批注信息")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的显示文本信息")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的数字格式设置信息")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的填充颜色索引")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的文字颜色索引")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的文字是否粗体")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的文字是否斜体")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取单元格的文字字号")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取当前工作表名称")]
        public static object GetCurrentWorkSheetName()
        {
            return Common.ExcelApp.ActiveSheet.Name;
        }

        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取当前工作薄名称")]
        ...
        [ExcelFunction(Category = "Excel对象属性", IsVolatile = true, IsMacroType = true, Description = "获取当前工作薄全路径")]
